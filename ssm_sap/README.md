...
> [!IMPORTANT]  
> AWS Launch Wizard for SAP now offers native integration with AWS Systems Manager for SAP. Please see https://aws.amazon.com/about-aws/whats-new/2024/10/sap-application-management-aws-launch-wizard-systems-manager-integration/
