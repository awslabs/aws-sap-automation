...
SWPM_2_0="https://softwaredownloads.sap.com/file/0020000000977752023"                        # SWPM20SP15_5-80003424.SAR      
SWPM_2_0_MD5="efd19dff2f9a00bd450b2a25624d10d68bd7b1be05fd21872af4e2801511ffae"
...
SAPHOSTAGENT_LATEST="https://softwaredownloads.sap.com/file/0020000000867792023"                # SAPHOSTAGENT61_61-80004822.SAR 19.07.2023 - SAP HOST AGENT 7.22 SP61
SAPHOSTAGENT_LATEST_MD5="280c13ca76d3b2fb1aba5cccdff9b9e3ae7988f6ca5f2553563fd2360dc8f688"

IGSHELPER_LATEST="https://softwaredownloads.sap.com/file/0020000000703122018"         # igshelper_17-10010245.sar - SAP IGS Fonts and Textures - 12.04.2018
IGSHELPER_LATEST_MD5="bc405afc4f8221aa1a10a8bc448f8afd9e4e00111100c5544097240c57c99732"
...
### HANA
HANADB_SWPM=${HANADB_LATEST}                                                                         
HANADB_SWPM_MD5=${HANADB_LATEST_MD5} 
...
NW750_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
NW750_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
NW750_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
NW750_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
NW752_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
NW752_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
NW752_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
NW752_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
NW750_JAVA_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
NW750_JAVA_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
NW750_JAVA_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
NW750_JAVA_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
BW4HANA20_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
BW4HANA20_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
BW4HANA20_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
BW4HANA20_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
BW4HANA21_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
BW4HANA21_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
BW4HANA21_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
BW4HANA21_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
S4HANA19_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
S4HANA19_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
S4HANA19_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
S4HANA19_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
S4HANA20_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
S4HANA20_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
S4HANA20_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
S4HANA20_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
S4HANA21_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
S4HANA21_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
S4HANA21_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
S4HANA21_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
S4HANA22_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
S4HANA22_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
S4HANA22_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
S4HANA22_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
S4HANA21_FOUNDATIONS_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
S4HANA21_FOUNDATIONS_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
S4HANA21_FOUNDATIONS_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
S4HANA21_FOUNDATIONS_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
S4HANA22_FOUNDATIONS_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
S4HANA22_FOUNDATIONS_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
S4HANA22_FOUNDATIONS_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
S4HANA22_FOUNDATIONS_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
SOLMAN72_KERNEL_IGSHELPER=${IGSHELPER_LATEST}
SOLMAN72_KERNEL_IGSHELPER_MD5=${IGSHELPER_LATEST_MD5}
...
SOLMAN72_KERNEL_SAPHOSTAGENT=${SAPHOSTAGENT_LATEST}
SOLMAN72_KERNEL_SAPHOSTAGENT_MD5=${SAPHOSTAGENT_LATEST_MD5}
...
then
  ...
  do
    ...
    echo -n "Validating link for "${ITEM_VARIABLE}
    WGET_LAST_HTTP_RC=`wget -q -r -U "SAP Download Manager" --max-redirect 0 --server-response --spider --http-user=$S_USER --http-password=$S_PASS --auth-no-challenge $SWDC_URL 2>&1 | grep -e "HTTP/*" | tail -1 | awk  '{print $2}'`
