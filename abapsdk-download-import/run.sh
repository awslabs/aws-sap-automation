...
aws s3 cp s3://aws-sap-automation/abapsdk-download-import/ ./abapsdk-download-import --recursive --region eu-central-1
...
chmod +x software_download/lw_abapsdk_download_import.sh
cd abapsdk-download-import
./lw_abapsdk_download_import.sh lwpostscript importcore